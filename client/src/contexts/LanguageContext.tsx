...
const translations = {
  ...
  en: {
    ...
    'wizard.step1.subtitle': 'Define basic bot settings',
    'wizard.step2.title': 'AI Configuration',
    'wizard.step2.subtitle': 'Configure how your bot will respond',
    ...
    'wizard.step4.subtitle': 'Review all settings',
    'wizard.next': 'Next',
