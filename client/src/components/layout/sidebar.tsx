      ...
      <div className="flex flex-col w-64 bg-white border-r border-gray-200">
        ...
        <div className="flex items-center flex-shrink-0 px-6 py-4 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            {/* WhatsApp inspired icon with gradient colors */}
            <div className="relative w-12 h-12 bg-gradient-to-br from-green-500 to-orange-400 rounded-full flex items-center justify-center shadow-lg">
              <svg 
              ...
              <div className="absolute -top-1 -right-1 w-4 h-4 bg-gradient-to-r from-green-300 to-orange-300 rounded-full flex items-center justify-center animate-pulse">
          ...
          {navigation.map((item) => (
            <Link key={item.name} href={item.href}>
              <div className={`${
                ...
                {item.name}
                {item.badge && (
                  <span className="ml-auto bg-gradient-to-r from-green-500 to-orange-400 text-white text-xs rounded-full px-2 py-1">
                    {item.badge}
                  </span>
                )}
              </div>
