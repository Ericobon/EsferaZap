      ...
      <div className="flex flex-col w-64 bg-white border-r border-gray-200">
        ...
        <div className="flex items-center flex-shrink-0 px-6 py-4 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            {/* WhatsApp inspired icon with InsightEsfera colors */}
            <div className="relative w-12 h-12 bg-gradient-to-br from-blue-600 to-blue-800 rounded-full flex items-center justify-center shadow-lg">
              <svg 
              ...
              {/* Network/connection dots in corner */}
